          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 pr-10 text-sm outline-none focus:ring-2 focus:ring-[#C2C719]"
                placeholder="••••••••"
              />
              <button
                type="button"
              ...
              >
                {showPwd ? (
                  ...
                  >
                    ...
                    <path d="M16.24 16.24A9.77 9.77 0 0 1 12 18c-5 0-9-6-9-6a18.3 18.3 0 0 1 4.28-4.69" />
                    <path d="M9.88 5.46A9.64 9.64 0 0 1 12 5c5 0 9 6 9 6a18.66 18.66 0 0 1-2.36 3.11" />
                  </svg>
                ) : (
                  <svg
                    width="18"
